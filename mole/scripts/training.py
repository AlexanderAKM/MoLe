...
_SHARED_HPARAMS_MULTIPLE_LAYERS = {
    'smiles_column': 'smiles',
    'output_dir': str(_TRAINED),
    'epochs': 100,
    'batch_size': 32,
...
# %%
# =============================================================================
# ESOL multiple layers (and thus non-linearities) in the head
# =============================================================================
esol_parser = argparse.Namespace(**{**_SHARED_HPARAMS_MULTIPLE_LAYERS, 'target_column': 'solubility'})
norm_train_esol, norm_val_esol, norm_test_esol, esol_scaler = _load_and_normalize("esol", esol_parser.target_column)

# %%
esol_results = train_chemberta_model(
    esol_parser, norm_train_esol, norm_test_esol, esol_scaler,
    df_val=norm_val_esol, dataset_name="train_esol", model_name="chemberta_mlp",
)
esol_results
# %%
# =============================================================================
